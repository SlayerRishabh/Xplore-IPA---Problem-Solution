...
Create a class com.X30Marks.Institution with below attributes:
...
This method will take two input parameters - array of com.X30Marks.Institution objects and string parameter location.
...
This method will take a String parameter institutionName, along with the array of com.X30Marks.Institution objects.
...
For updateInstitutionGrade method - The main method should print the institutionName and grade of the returned com.X30Marks.Institution object. The instituationName and grade should be concatinated with :: while printing. eg:- TCS::A, where TCS is the institution name and A is the grade.
...
## Starter Code
    ...
    public static int findNumClearancedByLoc(com.X30Marks.Institution[] instArray, String location)
    {
    //method logic
    }

    public static com.X30Marks.Institution updateInstitutionGrade(com.X30Marks.Institution[] instArray, String instName)
    {
    //method logic
    }
    }
    class com.X30Marks.Institution
    {
    //code to build com.X30Marks.Institution class
    }
